...
if(!isset($_SESSION['cli_sessmemopay'])){
	...
	if($_SESSION['cli_sessmemopay'][0]['complete_account'] <= 16){
		...
		if(isset($_SESSION['cli_sessmemopay'][0]['photo_dni_front']) && !empty($_SESSION['cli_sessmemopay'][0]['photo_dni_front']) && 
			 isset($_SESSION['cli_sessmemopay'][0]['photo_dni_back']) && !empty($_SESSION['cli_sessmemopay'][0]['photo_dni_back'])){
...
<html lang="es">
<head>
	<title>Memopay | Validación Biométrica </title>
