		...
		<div class="cFooter--contT--c box">
			<section class="cFooter--contT--c--sec">
				...
				<div class="cFooter--contT--c--sec--c">
					...
					<ul class="cFooter--contT--c--sec--c--m">
						<li class="cFooter--contT--c--sec--c--m--item"><a href="" id="" class="cFooter--contT--c--sec--c--m--link">Términos y condiciones</a></li>
						...
						<li class="cFooter--contT--c--sec--c--m--item"><a href="" id="" class="cFooter--contT--c--sec--c--m--link">Libro de reclamaciones</a></li>
					</ul>
				</div>
				<div class="cFooter--contT--c--sec--c">
					<h3 class="cFooter--contT--c--sec--c--title">Datos de contacto</h3>
					<ul class="cFooter--contT--c--sec--c--m">
						<li class="cFooter--contT--c--sec--c--m--item"><a href="" id="" class="cFooter--contT--c--sec--c--m--link">contacto@micambista.net</a></li>
						<li class="cFooter--contT--c--sec--c--m--item"><a href="" id="" class="cFooter--contT--c--sec--c--m--link">Lunes a Viernes 9 a.m - 7 p.m</a></li>
						<li class="cFooter--contT--c--sec--c--m--item"><a href="" id="" class="cFooter--contT--c--sec--c--m--link">Sábados y Feriados 9 a.m - 2.30 p.m</a></li>
					</ul>
				</div>
			</section>
		</div>
