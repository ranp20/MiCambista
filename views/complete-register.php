...
<html lang="es">
<head>
  <title>Mi Cambista | Completar registro </title>
  ...
  <div class="cCRegister">
    ...
    <div class="cCRegister__cont">
      <div class="cCRegister__cont--fCRegister box">
        ...
        <form method="POST" class="cCRegister__cont--fCRegister--form" id="Account-PInstakash">
          <div class="cCRegister__cont--fCRegister--form--controls">
            ...
            <input type="text" name="names-micambista" id="names-micambista" class="cCRegister__cont--fCRegister--form--controls--input" placeholder="Nombre(s)">
          ...
          <div class="cCRegister__cont--fCRegister--form--controls">
            ...
            <input type="text" name="lastnames-micambista" id="lastnames-micambista" class="cCRegister__cont--fCRegister--form--controls--input" placeholder="Apellido(s)">
          ...
          <div class="cCRegister__cont--fCRegister--form--controlsTwo">
            ...
            <div class="cCRegister__cont--fCRegister--form--controlsTwo--c">
              ...
              <input type="number" name="nrodocument-micambista" id="nrodocument-micambista" class="cCRegister__cont--fCRegister--form--controls--input" placeholder="Nro. de documento" maxlength="15">
