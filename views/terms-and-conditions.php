		...
		<div class="cMain__cont">
			...
			<section class="cMain__cont__terms-and-conditions section-wrapper" id="fromHereFixedHeadTop">
				<div class="cMain__cont__terms-and-conditions__c">
					...
					<p>Los Términos y Condiciones aquí señalados representan un contrato (en adelante, el “Contrato”) entre el usuario (en adelante, “EL CLIENTE”) y MEMOPAY (en adelante, “→”). Los Términos y Condiciones detallan los servicios que presta CAMBIA FX y las condiciones que acepta EL CLIENTE al acceder a los mismos.</p>
					<div class="cMain__cont__terms-and-conditions__c__cTermsAndConditions">
						<div class="cMain__cont__terms-and-conditions__c__cTermsAndConditions__item">
							...
							<p>MEMOPAY es una empresa que tiene por finalidad realizar el servicio de cambio de divisas en el Perú a través de su portal web “www.memopay.com.pe” (en adelante el “Portal Web”). MEMOPAY se encuentra debidamente registrada con RUC. Nro. 20604340994, con domicilio legal en Jr. Andahuaylas 271 int 02 Lima-Lima-Lima, Perú.</p>
							<p>Asimismo, MEMOPAY se encuentra autorizada para operar como empresa de cambio de divisas y se encuentra registrada en la Superintendencia de Banca, Seguros y AFP (En adelante SBS) a través de su resolución SBS N° 04237-2019.</p>
						</div>
						<div class="cMain__cont__terms-and-conditions__c__cTermsAndConditions__item">
							<h5 class="cMain__cont__terms-and-conditions__c__cTermsAndConditions__item__subtitle">2. OBJETO DEL CONTRATO</h5>
							<p>El objeto del presente contrato es que EL CLIENTE se informe de los términos y condiciones del servicio prestado por MEMOPAY, por ende, le recomendamos que lea este contrato de forma detallada antes de hacer uso del mismo. Al registrarse o hacer uso de nuestro servicio a través de nuestro PORTAL WEB usted estará aceptando los términos y condiciones descritos en el presente contrato.</p>
							<p>Tenga en cuenta que de no aceptar este contrato no podrá hacer uso del servicio brindado por MEMOPAY.</p>
						</div>
						<div class="cMain__cont__terms-and-conditions__c__cTermsAndConditions__item">
							<h5 class="cMain__cont__terms-and-conditions__c__cTermsAndConditions__item__subtitle">3. TARIFARIO Y COMISIONES</h5>
							<p>MEMOPAY no cobra ninguna comisión por el uso del servicio mediante PORTAL WEB.</p>
						...
						<div class="cMain__cont__terms-and-conditions__c__cTermsAndConditions__item">
							...
							<p>EL CLIENTE es responsable de su propia contraseña, y deberá mantenerla bajo absoluta reserva y confidencialidad, sin revelarla o compartirla, en ningún caso, con terceros. Cada cliente es responsable de todas las acciones realizadas mediante el uso de su contraseña. MEMOPAY informa al cliente que toda acción realizada a través de la cuenta de usuario personal se presume realizada por EL CLIENTE titular de dicha cuenta.</p>
							<p>MEMOPAY podrá solicitar información adicional para el registro de usuario o perfiles, en caso lo considere necesario o sea una exigencia de las entidades supervisoras.</p>
							...
							<p>MEMOPAY opera con cuentas bancarias de las siguientes entidades financieras:</p>
							<ul>
							...
							<p>Cada cliente puede tener solo una cuenta de usuario, en caso se detecte a un cliente con más de una cuenta de usuario, MEMOPAY se reserva el derecho a desactivar o fusionar las otras cuentas, sin previo aviso al titular de la cuenta.</p>
							<p>MEMOPAY podrá suspender la cuenta de usuario cuando considere que esta ya no es segura, o si se recibe alguna queja o denuncia respecto a la cuenta de usuario.</p>
						</div>
						<div class="cMain__cont__terms-and-conditions__c__cTermsAndConditions__item">
							...
							<p>El tipo de cambio acordado entre EL CLIENTE y MEMOPAY tiene una vigencia máxima de 15 minutos a partir del registro de su operación en PORTAL WEB, en estos 15 minutos EL CLIENTE deberá realizar la transferencia del monto acordado a la cuenta bancaria indicada de MEMOPAY y seguidamente deberá adjuntar o enviar el váucher de la transferencia al correo electrónico indicado. En caso, EL CLIENTE no realice la transferencia pasada este tiempo perderá el tipo de cambio acordado y la operación será anulada de forma automática.</p>
							<p>En caso el cliente realice la transferencia pasado el tiempo de vigencia máxima, se propondrá un nuevo tipo de cambio en base a la fecha y hora de la recepción del monto que figura en los movimientos de la cuenta bancaria de MEMOPAY.</p>
							...
							<p>Es importante recalcar que MEMOPAY opera a nivel nacional únicamente con cuentas bancarias del BCP E INTERBANK. Adicionalmente, para la provincia de Lima opera con cuentas bancarias de otras entidades financieras, siempre que hayan sido aperturadas en dicha provincia y por medio de transferencias interbancarias utilizando el Código de Cuenta Interbancario (CCI).</p>
							...
							<p>Una vez que EL CLIENTE haya registrado su operación, deberá proceder a realizar la transferencia del monto a la cuenta bancaria de MEMOPAY, en un tiempo máximo de 15 minutos a partir del registro de su operación para poder mantener el tipo de cambio acordado. Seguidamente, deberá adjuntar o enviar el váucher de la transferencia realizada al correo “transferencias@memopay.com”.</p>
							<p>MEMOPAY no acepta depósitos en efectivo.</p>
							<p>MEMOPAY acepta transferencias bancarias a nivel nacional desde cualquier cuenta bancaria del BCP E INTERBANK.</p>
							<p>MEMOPAY acepta transferencias interbancarias inmediatas de otras entidades financieras solo para cuentas bancarias aperturadas en la provincia de Lima. En caso que EL CLIENTE realice una transferencia interbancaria desde una cuenta aperturada en otra localidad, EL CLIENTE deberá asumir el costo de la transferencia inmediata cobrada por su entidad financiera y ejecutar la transferencia dentro de los horarios establecidos para la operativa interbancaria; el cual establece que el tiempo para realizar este tipo de operaciones es de Lunes a Viernes de 8:30 am y 3:45 pm de días hábiles.</p>
							<p>En caso que EL CLIENTE realice una transferencia interbancaria regular, deberá asumir el tiempo que demore la transferencia en figurar en la cuenta de MEMOPAY.</p>
							<h5 class="cMain__cont__terms-and-conditions__c__cTermsAndConditions__item__subtitle">5.5. Emisión de fondos</h5>
							<p>Una vez se verifique la recepción del fondo en la cuenta de MEMOPAY y se contraste con el Váucher enviado por el cliente, se procederá a realizar la emisión de fondo acordado a la cuenta destino del cliente.</p>
							<p>MEMOPAY tiene cuentas bancarias en el BCP E INTERBANK. Las transferencias hacia otros bancos serán consideradas como transferencias interbancarias.</p>
							<p>El tiempo para las transferencias a cuentas bancarias del BCP E INTERBANK E INTERBANK será un máximo de 15 minutos a partir de la recepción del fondo en la cuenta de MEMOPAY, siempre en cuando no se hayan establecido tiempos diferentes entre las partes. Cabe resaltar que MEMOPAY no se hace responsable de los tiempos que toman las entidades financieras para que el fondo esté disponible en la cuenta bancaria del titular.</p>
							...
							<p>En caso que MEMOPAY transfiera un monto distinto al acordado, se debe definir inmediatamente si el saldo es a favor del cliente o para MEMOPAY. Tanto EL CLIENTE como MEMOPAY se comprometen a transferir la cantidad necesaria para restablecer lo acordado. En caso el usuario no transfiera a MEMOPAY, este saldo será considerado una deuda. MEMOPAY recurrirá a reportar el incidente a centrales de riesgo crediticio y reportar a Infocorp.</p>
							<h5 class="cMain__cont__terms-and-conditions__c__cTermsAndConditions__item__subtitle">5.6. Anulación de la operación</h5>
							<p>MEMOPAY podrá realizar la anulación automática o manual de la operación en los siguientes casos:</p>
							...
							<ul class="anylst-onlypd">
								<li>a) Aceptar el nuevo tipo de cambio en base a la fecha y hora del abono que figura en los movimientos de la cuenta bancaria de MEMOPAY.</li>
								<li>b) Anular la operación, MEMOPAY realizará la devolución del monto abonado en la cuenta del cliente, previamente el cliente deberá asumir todos los costos o gastos en los que incurra MEMOPAY para la devolución.</li>
							</ul>
							<p>EL CLIENTE realice un depósito en efectivo en la cuenta de MEMOPAY, se procederá a realizar la devolución a la cuenta del cliente del monto depositado, previamente el cliente deberá asumir todos los costos o gastos en los que incurra MEMOPAY para la devolución.</p>
						...
						<div class="cMain__cont__terms-and-conditions__c__cTermsAndConditions__item">
							...
							<p>Compra: proceso mediante el cual EL CLIENTE transfiere dólares y MEMOPAY transfiere soles a EL CLIETNE.</p>
							<p>Venta: proceso mediante el cual EL CLIENE transfiere soles y MEMOPAY transfiere dólares a EL CLIENTE.</p>
						...
						<div class="cMain__cont__terms-and-conditions__c__cTermsAndConditions__item">
							...
							<p>Sin perjuicio de lo anterior, EL CLIENTE autoriza a MEMOPAY a verificar la veracidad de los datos personales facilitados por el Usuario a través de información obtenida de fuentes de acceso público o entidades especializadas en la provisión de dicha información.</p>
						...
						<div class="cMain__cont__terms-and-conditions__c__cTermsAndConditions__item">
							...
							<p>MEMOPAY se reserva expresamente el derecho a modificar, actualizar o completar en cualquier momento los presentes Términos y Condiciones.</p>
