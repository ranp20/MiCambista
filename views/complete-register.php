      ...
      <div class="cCRegister__cont--fCRegister box">
        ...
        <form method="POST" class="cCRegister__cont--fCRegister--form" id="frm-complAccRegCli">
          <div class="cCRegister__cont--fCRegister--form--controls">
            ...
            <input type="text" name="names-memopay" id="names-memopay" class="cCRegister__cont--fCRegister--form--controls--input" placeholder="Nombre(s)" required>
          ...
          <div class="cCRegister__cont--fCRegister--form--controls">
            ...
            <input type="text" name="lastnames-memopay" id="lastnames-memopay" class="cCRegister__cont--fCRegister--form--controls--input" placeholder="Apellido(s)" required>
          ...
          <div class="cCRegister__cont--fCRegister--form--controlsTwo">
            ...
            <div class="cCRegister__cont--fCRegister--form--controlsTwo--c">
              ...
              <input type="text" name="nrodocument-memopay" id="nrodocument-memopay" class="cCRegister__cont--fCRegister--form--controls--input" placeholder="Nro. de documento" maxlength="15" required>
