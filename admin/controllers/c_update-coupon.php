	...
	function update_coupon(){
		...
		if($_POST['buy_percent_desc'] != 0){
			if($_POST['sell_percent_desc'] != 0){
				try{
					$sql = "UPDATE tbl_coupon SET code_coupon = :code_coupon, larger_amounts = :larger_amounts, buy_percent_desc = :buy_percent_desc, buy_output_price = :buy_output_price, sell_percent_desc = :sell_percent_desc, sell_output_price = :sell_output_price WHERE id = :id";
