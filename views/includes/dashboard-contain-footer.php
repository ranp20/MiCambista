	...
	<div class="cControlP__cont--containDash--cFooter--c">
		...
		<ul class="cControlP__cont--containDash--cFooter--c--m">
			<li class="cControlP__cont--containDash--cFooter--c--m--item">
				<img src="./assets/img/svg/arrows-welcome-footer.svg" alt="">
				<p>Recibimos solo transferencias. <br> No aceptamos depósitos.</p>
			</li>
			<li class="cControlP__cont--containDash--cFooter--c--m--item">
				<img src="./assets/img/svg/user-welcome-footer.svg" alt="">
				<p>Recibimos solo transferencias. <br> No aceptamos depósitos.</p>
			</li>
			<li class="cControlP__cont--containDash--cFooter--c--m--item">
				<img src="./assets/img/svg/clock-welcome-footer.svg" alt="">
				<p>Recibimos solo transferencias. <br> No aceptamos depósitos.</p>
			</li>
			<li class="cControlP__cont--containDash--cFooter--c--m--item">
				<img src="./assets/img/svg/dollar-welcome-footer.svg" alt="">
				<p>Recibimos solo transferencias. <br> No aceptamos depósitos.</p>
			</li>
		</ul>
	</div>
