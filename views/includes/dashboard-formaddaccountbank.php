	...
	<form method="POST" class="cformAddAccountBank--form" id="form-AddAccountBank">
		<div class="cformAddAccountBank--form--cBtnClose">
			<span id="icon_frmbtnClose">
				<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="16px" height="16px" version="1.1" viewBox="0 0 700 700">
				 <defs>
				  ...
				  <symbol id="d" overflow="visible">
				   <path d="m18.578-26.516c-2.5 0-4.4453 0.92969-5.8281 2.7812-1.375 1.8555-2.0625 4.4609-2.0625 7.8125 0 3.3555 0.6875 5.9609 2.0625 7.8125 1.3828 1.8438 3.3281 2.7656 5.8281 2.7656 2.5195 0 4.4727-0.92188 5.8594-2.7656 1.3828-1.8516 2.0781-4.457 2.0781-7.8125 0-3.3516-0.69531-5.957-2.0781-7.8125-1.3867-1.8516-3.3398-2.7812-5.8594-2.7812zm0-5.9531c5.1328 0 9.1484 1.4688 12.047 4.4062 2.9062 2.9297 4.3594 6.9766 4.3594 12.141 0 5.1562-1.4531 9.2031-4.3594 12.141-2.8984 2.9375-6.9141 4.4062-12.047 4.4062-5.1055 0-9.1172-1.4688-12.031-4.4062-2.918-2.9375-4.375-6.9844-4.375-12.141 0-5.1641 1.457-9.2109 4.375-12.141 2.9141-2.9375 6.9258-4.4062 12.031-4.4062z"/>
				  </symbol>
		...
		<div class="cformAddAccountBank--form--cControl">
			...
			<div class="cformAddAccountBank--form--cControl--cSelItem" id="selListallCurrencyTypes">
