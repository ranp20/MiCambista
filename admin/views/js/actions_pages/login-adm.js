  	...
  	if(e != "" && e != "[]"){
	  	...
	  	if(r.res == "true"){
				...
				$("#msgAlertLogin").html(`<div class="msgAlertLogin--error">
																...
																`);
				setTimeout(function(){$('.msgAlertLogin--error').addClass('disabled');}, 4500);
				...
				$("#btnCloseErr").on("click", function(){$(".msgAlertLogin--error").addClass("disabled");});
			}else{
				$("#msgAlertLogin").html(`<div class="msgAlertLogin--error">
																	<div class="msgAlertLogin--error--c">
																		<span class="msgAlertLogin--error--c--close" id="btnCloseErr"></span>
